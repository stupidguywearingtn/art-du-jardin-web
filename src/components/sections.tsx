...
const REASONS = [
  ...
  { n: "02", t: "1000+ chantiers", d: "Plus de 1000 chantiers réalisés dans le Jura et l'Ain avec 20 ans d'expérience.", icon: "M12 2l2.4 5 5.6.8-4 3.9 1 5.5L12 14.8 6.9 17.2l1-5.5-4-3.9L9.6 7Z" },
