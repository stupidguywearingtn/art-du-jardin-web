...
const WHY_US_CARDS_FALLBACK: WhyUsCard[] = [
  ...
  { id: "fb-3", title: "Devis détaillé", description: "Visite gratuite, devis détaillé, prix tenus, aucune mauvaise surprise.", icon_name: "file-text", display_order: 3, active: true },
